...
# Зиг-Заг по фракталам (как на TradingView)
ZIGZAG_LINE         = "#4fc3f7"  # Небесно-голубой цвет ломаной линии ЗигЗага (TradingView cyan)
ZIGZAG_HIGH_DOT     = "#00e676"  # Зеленая точка на пике High
ZIGZAG_LOW_DOT      = "#ff5252"  # Красная точка на дне Low
